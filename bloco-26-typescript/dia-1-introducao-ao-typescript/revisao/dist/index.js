...
if (month === months_1.default.January || month === months_1.default.February || month === months_1.default.March)
    console.log(seasons_1.default.Winter);
if (month === months_1.default.April || month === months_1.default.May || month === months_1.default.June)
    console.log(seasons_1.default.Spring);
if (month === months_1.default.July || month === months_1.default.August || month === months_1.default.September)
    console.log(seasons_1.default.Summer);
if (month === months_1.default.October || month === months_1.default.November || month === months_1.default.December)
    console.log(seasons_1.default.Autumn);
